...
import view.windows.VisualAidWindow;
...
public class WindowManager {
  ...
  private VisualAidWindow visualWindow;
  ...
  /**
   * Returns the {@link VisualAidWindow} used in GUI
   *
   * @return the {@link VisualAidWindow} object from GUI
   */
  public VisualAidWindow getVisualAidWindow() {
    return visualWindow;
  }
  ...
  public void createGUI() {
    ...
    visualWindow = new VisualAidWindow();
 ...
 public void setVisible() {
   ...
   * Displays the {@link AboutWindow}
   */
  public void showVisualAidWindow() {
    getVisualAidWindow().show();
  }
