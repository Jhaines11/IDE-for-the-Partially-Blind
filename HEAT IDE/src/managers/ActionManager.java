...
public class ActionManager {
  ...
  private ShowVisualAction showVisualAction = new ShowVisualAction(null,
	      Resources.getIcon("eye22"), "Visual Aid", null, null);
  ...
  public ActionManager.ShowVisualAction getVisualActionWindow(){
	  return showVisualAction;
  }
 ...
 /* end ShowAboutAction */
  ...
  public class RedoAction extends AbstractAction {
   ...
   protected class GoToRecentConsoleHistory extends AbstractAction{
    ...
    protected class ShowVisualAction extends AbstractAction {
	    public ShowVisualAction(String text, ImageIcon icon, String desc,
	      Integer mnemonic, KeyStroke accelerator) {
	      super(text, icon);
	      putValue(SHORT_DESCRIPTION, desc);
	      putValue(MNEMONIC_KEY, mnemonic);
