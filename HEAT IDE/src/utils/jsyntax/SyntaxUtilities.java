...
public class SyntaxUtilities {
  ...
  public static SyntaxStyle[] getDefaultSyntaxStyles() {
    SyntaxStyle[] styles = new SyntaxStyle[Token.ID_COUNT];
    	/* Comments */
        styles[Token.COMMENT1] = new SyntaxStyle(new Color(0xFFFFE0), false, false);
        styles[Token.COMMENT2] = new SyntaxStyle(new Color(0x650099), false, false);
        /* Keywords */
        styles[Token.KEYWORD1] = new SyntaxStyle(Color.red, false, true);
        styles[Token.KEYWORD2] = new SyntaxStyle(new Color(0xFFFFE0), false, false);
        styles[Token.KEYWORD3] = new SyntaxStyle(new Color(0x00FFFF), false, true);
        styles[Token.LITERAL1] = new SyntaxStyle(new Color(0x650099), false, false);
        styles[Token.LITERAL2] = new SyntaxStyle(new Color(0xE9B8EC), false, true);
