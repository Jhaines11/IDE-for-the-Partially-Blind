...
public class Toolbar {
  ...
  private ImageIcon visualAidIcon = Resources.getIcon("eye22");
  ...
  private JButton visualAidButton = new JButton(am.getVisualActionWindow());
